...
export const WebNavbar: React.FC = () => {
  const { activeWebTab, setActiveWebTab, orders, ingredients, shifts, currentProfile } = useTsosStore();
  ...
  const allPrimaryTabs: { id: WebTab; label: string; icon: React.ReactNode; badge?: number; badgeColor?: string }[] = [
